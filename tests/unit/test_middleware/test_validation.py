...
class TestValidationMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_tool_call_permission_denied(self, validation_middleware, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_tool_call_permission_allowed(self, validation_middleware, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_service_account_has_all_permissions(self, validation_middleware, mock_call_next):
