...
class TestRateLimitMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_allow_requests_within_limit(self, rate_limit_middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_block_requests_exceeding_minute_limit(self, rate_limit_middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_token_bucket_burst_control(self, rate_limit_middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_service_accounts_bypass_rate_limit(self, rate_limit_middleware, mock_request, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_different_users_have_separate_limits(self, rate_limit_middleware, mock_call_next):
    ...
    @pytest.mark.asyncio
    async def test_get_usage_stats(self, rate_limit_middleware, mock_request, mock_call_next):
    ...
    async def test_cleanup_old_requests(self, rate_limit_middleware):
        ...
        allowed, retry_after = await rate_limit_middleware._check_memory_rate_limit(user_id)
