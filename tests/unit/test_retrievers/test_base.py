...
class TestRetrieverHealth:
    ...
    def test_health_model_creation(self):
        ...
        health = RetrieverHealth(healthy=True, service_name="test_service")
    ...
    def test_health_model_with_details(self):
        ...
        health = RetrieverHealth(
            healthy=True, service_name="test_service", details=details
        )
    ...
    def test_unhealthy_status_with_error(self):
        ...
        health = RetrieverHealth(
            healthy=False, service_name="test_service", error="Connection timeout"
        )
