...
class TestRetrieverFactory:
    ...
    def test_register_retriever(self):
        ...
        class MockRetriever(Retriever):
            ...
            async def retrieve(self, query, limit=10, **kwargs): yield {}
    ...
    def test_create_unregistered_retriever(self):
        ...
        with pytest.raises(RetrieverFactoryError, match="Unknown retriever type: unknown"):
...
class TestRetrieverFactoryConfigValidation:
    ...
    def test_create_with_extra_config(self):
        ...
        assert retriever.received_config == {
            "api_key": "test",
            "extra_param": "value"
        }
