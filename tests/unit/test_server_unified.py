...
from src.retrievers.base import QueryError
...
class TestUnifiedMCPServer:
    ...
    def complete_config(self):
        ...
        config.auth_config.internal_api_key = "mock-internal-api-key-that-is-long-enough-for-validation"
        config.auth_config.jwt_secret_key = "mock-jwt-secret-key-that-is-long-enough-for-validation"
...
class TestServerTools:
    ...
    async def test_search_web_tool(self, mock_server, mock_context):
        ...
        # Get search_web function from the server module
        search_web = None
    ...
    async def test_health_check_tool(self, mock_server, mock_context):
        ...
        health = {
            "status": "healthy" if all(r["connected"] for r in retriever_health.values()) else "degraded",
...
class TestCachingTools:
    ...
    async def test_invalidate_cache_tool(self, cached_server, mock_context):
        ...
        mcp = cached_server.create_server()
