...
class SentryIntegration:
    ...
    def setup(self):
        ...
        sentry_sdk.init(
            ...
            profiles_sample_rate=self.profiles_sample_rate if self.enable_performance else 0.0,
    ...
    def set_request_context(self, request_id: str, method: str, tool_name: Optional[str] = None):
