...
class MetricsMiddleware:
    ...
    def __init__(
        ...
        self._error_count = 0
        self._tool_metrics: Dict[str, Dict[str, Any]] = defaultdict(lambda: {
            "count": 0,
            "errors": 0,
            "total_duration_ms": 0,
    ...
    async def _update_metrics(
        ...
        async with self._lock:
            ...
            if tool_name and self.enable_detailed_metrics:
                ...
                tool_stats["avg_duration_ms"] = tool_stats["total_duration_ms"] / tool_stats["count"]
    ...
    async def get_metrics_summary(self) -> Dict[str, Any]:
        ...
        async with self._lock:
            ...
            success_rate = ((self._request_count - self._error_count) / self._request_count * 100) if self._request_count > 0 else 0
            ...
            return {
                ...
                "tool_metrics": {
                    name: stats for name, stats in top_tools
                },
                "top_users": [
                    {
                        "user_id": user_id,
    ...
    async def get_tool_metrics(self, tool_name: str) -> Dict[str, Any]:
        ...
        async with self._lock:
            return dict(self._tool_metrics.get(tool_name, {
                "count": 0,
                "errors": 0,
                "total_duration_ms": 0,
                "min_duration_ms": 0,
