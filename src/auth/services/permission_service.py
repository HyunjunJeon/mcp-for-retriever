...
class PermissionService:
    ...
    async def _fetch_role_permissions(self, roles: list[str]) -> list[ResourcePermission]:
        """역할별 권한 DB 조회"""
        query = """
    ...
    def _merge_permissions(self, permissions: list[ResourcePermission]) -> list[ResourcePermission]:
        """
        중복 권한 병합
    ...
    def _get_default_role_permissions(self, roles: list[str]) -> list[ResourcePermission]:
        """
        기본 역할별 권한 (하드코딩)
